...
use Map2u\ForumBundle\Component\Dispatcher\Event\ModeratorTopicResponseEvent;
...
class ModeratorTopicController extends ModeratorTopicBaseController
{
    ...
    public function deleteAction($forumName, $topicId)
    {
        ...
        $response = $this->renderResponse('Map2uForumBundle:Moderator:Topic/delete.html.', array(
    ...
    public function changeBoardAction($forumName, $topicId)
    {
        ...
        $response = $this->renderResponse('Map2uForumBundle:Moderator:Topic/change_board.html.', array(
