...
use Map2u\ForumBundle\Component\Dispatcher\Event\AdminBoardResponseEvent;
...
class AdminBoardController extends AdminBoardBaseController
{
    ...
    public function listAction()
    {
        ...
        $response = $this->renderResponse('Map2uForumBundle:Admin:/Board/list.html.', array(
    ...
    public function createAction()
    {
        ...
        $response = $this->renderResponse('Map2uForumBundle:Admin:/Board/create.html.', array(
    ...
    public function editAction($boardId)
    {
        ...
        $response = $this->renderResponse('Map2uForumBundle:Admin:/Board/edit.html.', array(
    ...
    public function deleteAction($boardId)
    {
        ...
        $response = $this->renderResponse('Map2uForumBundle:Admin:/Board/delete.html.', array(
