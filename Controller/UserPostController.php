...
use Map2u\ForumBundle\Component\Dispatcher\Event\UserPostResponseEvent;
...
class UserPostController extends UserPostBaseController
{
    ...
    public function showAction($forumName, $postId)
    {
        ...
        return $this->renderResponse('Map2uForumBundle:User:Post/show.html.', array(
    ...
    public function editAction($forumName, $postId)
    {
        ...
        $response = $this->renderResponse('Map2uForumBundle:User:Post/edit.html.', array(
            'crumbs' => $this->getCrumbs()->addUserPostShow($forum, $post),
            'forum' => $forum,
            'forumName' => $forumName,
            'post' => $post,
    ...
    public function deleteAction($forumName, $postId)
    {
        ...
        $response = $this->renderResponse('Map2uForumBundle:User:Post/delete.html.', array(
