...
use Map2u\ForumBundle\Component\Dispatcher\Event\ModeratorPostResponseEvent;
...
class ModeratorPostController extends ModeratorPostBaseController
{
    ...
    public function unlockAction($forumName, $postId)
    {
        ...
        $response = $this->renderResponse('Map2uForumBundle:Moderator:Post/unlock.html.', array(
