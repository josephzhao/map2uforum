...
use Map2u\ForumBundle\Component\Dispatcher\Event\UserTopicResponseEvent;
...
class UserTopicController extends UserTopicBaseController
{
    ...
    public function showAction($forumName, $topicId)
    {
        ...
        $response = $this->renderResponse('Map2uForumBundle:User:Topic/show.html.', array(
    ...
    public function createAction($forumName, $boardId)
    {
        ...
        $response = $this->renderResponse('Map2uForumBundle:User:Topic/create.html.', array(
    ...
    public function replyAction($forumName, $topicId)
    {
        ...
        $response = $this->renderResponse('Map2uForumBundle:User:Topic/reply.html.', array(
