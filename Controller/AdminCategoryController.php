...
use Map2u\ForumBundle\Component\Dispatcher\Event\AdminCategoryResponseEvent;
...
class AdminCategoryController extends AdminCategoryBaseController
{
    ...
    public function listAction()
    {
        ...
        $response = $this->renderResponse('Map2uForumBundle:Admin:/Category/list.html.', array(
    ...
    public function createAction()
    {
        ...
        $response = $this->renderResponse('Map2uForumBundle:Admin:/Category/create.html.', array(
    ...
    public function editAction($categoryId)
    {
        ...
        $response = $this->renderResponse('Map2uForumBundle:Admin:/Category/edit.html.', array(
    ...
    public function deleteAction($categoryId)
    {
        ...
        $response = $this->renderResponse('Map2uForumBundle:Admin:/Category/delete.html.', array(
